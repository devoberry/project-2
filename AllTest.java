...
public class AllTest {
	...
	public void testSearch(){
		...
		String returned = Driver.search(inputs);
	...
	public void testTitleList(){
		...
		/*     createYearMovieList
		 *            Create different arrayLists of 2 and sort them by title or by release year using Media gets
		 *            
		 */
	...
	public void testParseSeries(){
		...
		episodes.add(Driver.parseEpisode("\"Star Trek: Deep Space Nine\" " +"(1993) {You Are Cordially Invited... (#6.7)}	1997"));
