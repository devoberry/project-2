...
public class Series extends Media{
	...
	public Series(String title, Integer releaseYear, Integer endYear, 
			String unspecified, String suspended){
		this.title = title;
	 ...
	 * @param String to be parsed with format "title" (year) year-year
	 * @return void
	 */
	public static Series parseNewSeries(String line){
		Series series = new Series(parseSeriesTitle(line), parseSeriesRelease(line), 
				parseSeriesEnd(line), parseSeriesUnspecified(line), 
				parseSeriesSuspended(line));
		return series;
	}
	 ...
	 * @param String to be parsed with the format "title" (year) year-year
	 * @return void
	 */
	 ...
	 * @param String to be parsed with the format "title" (year) year-????
	...
	/**
	 * This method will take a string and parse whether or not a series has been suspended
	 * @param String to be parsed that may contain {{suspended}}
	 * @return void
	 */
	...
	public String toString(){
		String str = "\"" + this.getTitle() + "\" (" +Integer.toString(this.getReleaseYear()) + ") "+ Integer.toString(this.getReleaseYear()) 
		+"-";
